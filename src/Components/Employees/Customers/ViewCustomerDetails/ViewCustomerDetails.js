            ...
            <div className="smallBox40">
                ...
                <ul className="smallBox22 nav">
                    <li className="nav-item highlight smallBox23">
                        {clicked[0] ? <span className="nav-link textDecoGreen pointer smallBox23" onClick={navigateToCustomerTransactions}>Transactions</span> :
                        <span className="nav-link textDecoWhite pointer smallBox23" onClick={navigateToCustomerTransactions}>Transactions</span>}
                    </li>
                    <li className="nav-item highlight smallBox23">
                        {clicked[1] ? <span className="nav-link textDecoGreen pointer smallBox23" onClick={navigateToCustomerAccounts}>Accounts</span> :
                        <span className="nav-link textDecoWhite pointer smallBox23" onClick={navigateToCustomerAccounts}>Accounts</span>}
                    </li>
                    <li className="nav-item highlight smallBox23">
                        {clicked[2] ? <span className="nav-link textDecoGreen pointer smallBox23" onClick={navigateToCustomerLoans}>Loans</span> :
                        <span className="nav-link textDecoWhite pointer smallBox23" onClick={navigateToCustomerLoans}>Loans</span>}
                    </li>
                    <li className="nav-item highlight smallBox23">
                        {clicked[3] ? <span className="nav-link textDecoGreen pointer smallBox23" onClick={navigateToCustomerDetails}>Details</span> :
                        <span className="nav-link textDecoWhite pointer smallBox23" onClick={navigateToCustomerDetails}>Details</span>}
                    </li>
                    <li className="nav-item highlight smallBox23">
                        {clicked[4] ? <span className="nav-link textDecoGreen pointer smallBox23" onClick={navigateToCreditWorthiness}>Credit</span> :
                        <span className="nav-link textDecoWhite pointer smallBox23" onClick={navigateToCreditWorthiness}>Credit</span>}
                    </li>
                </ul>
