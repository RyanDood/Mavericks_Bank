        ...
        <div className="smallBox17 col-md-9">
            ...
            <ul className="smallBox22 nav">
                        <li className="nav-item highlight smallBox23">
                            <Link className="nav-link textDecoGreen smallBox23" to="/adminMenu/allCustomers">All Customers</Link>
                        </li>
                        <li className="nav-item highlight smallBox23">
                            <Link className="nav-link textDecoWhite smallBox23" to="/adminMenu/createCustomer">Create Customer</Link>
                        </li>
                </ul>}
